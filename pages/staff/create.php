...
if (isset($_POST['btn_add'])) {
    ...
    $insertStaff = "CALL them_nv('" . $_POST["nv_name"] . "', '" . $_POST["nv_gender"] . "', '" . $_POST["nv_birth"] . "', '" . $_POST["nv_work"] . "', '" . $_POST["nv_address"] . "', '" . $_POST["nv_role"] . "', '" . $_POST["nv_phone"] . "', '" . $_POST["nv_pay"] . "' )";
                            ...
                            <div class="col-3">
                                <form method="POST" name="add_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nv_gender" class="form-control" id="gender" placeholder="Nhập giới tính">
                                    </div>
                                    <div class="form-group">
                                        <label for="birth">Ngày sinh</label>
                                        <input type="date" name="nv_birth" class="form-control" id="birth" placeholder="Nhập ngày sinh YYYY-MM-DD">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nv_address" class="form-control" id="address" placeholder="Nhập ngày địa chỉ">
                                    </div>
                                    <div class="form-group">
                                        <label for="role">Chức vụ</label>
                                        <input type="text" name="nv_role" class="form-control" id="role" placeholder="Nhập Chức vụ">
                                    </div>
                                    <div class="form-group">
